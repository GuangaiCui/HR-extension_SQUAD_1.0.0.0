report 53053 "Mapa CGA - Fechado"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/Layouts/MapaCGAFechado.rdlc';
                ...
                begin
                    ...
                    if ("Cód. Situação" = '01') and (not FLAG) then begin
                        ...
                        if recRubricaSalarial.FindSet then begin
                            repeat
                                ...
                                recHistLinMovEmp.SetRange(recHistLinMovEmp."No. Empregado", "Hist. Linhas Movs. Empregado"."No. Empregado");
                    ...
                    if ("Hist. Linhas Movs. Empregado".Valor <> 0) or
                        ...
                        if Empregado."Nº Horas Docência Calc. Desct." <> 0 then begin
                            //ValorRemuneracao := ValorRemuneracao / Empregado."Nº Horas Semanais" * Empregado."Nº Horas Docência Calc. Desct.";
                            //ValorRemuneracao := ValorRemuneracao / NhorasSem * Empregado."Nº Horas Docência Calc. Desct.";3
                            ...
                            if Empregado."Regime Duração Trabalho" = Empregado."Regime Duração Trabalho"::"1" then begin
                                ...
                                if GrauFuncao.Get(Nivel) then begin
                                    ...
                                    if ValorRemuneracao > (GrauFuncao."Valor Hora Semanal" * NhorasSem) then begin
                                        ...
                                        //ValorRemuneracao := ValorRemuneracao / NhorasSem * NhorasDocencia; 2008.05.04
                                        ValorRemuneracao := Round(ValorRemuneracao, 0.01);
                                    end;
                                end;
                            end;
                        ...
                        if "Hist. Linhas Movs. Empregado"."Cód. Situação" = '01' then begin
                            ...
                            if Empregado."Regime Duração Trabalho" = Empregado."Regime Duração Trabalho"::"2" then
                                ...
                                //HG 2008.10.23 - no caso dos parciais temos de ir ler às horas lectivas, porque as totais podem passam das 22
                        ...
                        if ("Hist. Linhas Movs. Empregado"."Cód. Situação" = '00') then begin
                            ...
                            if TabCatProfQPEmpregado.FindLast then
                        ...
                        if TabCodigosSituacao.FindFirst then begin
                            if not TabCodigosSituacao."Perdas Efectivas" then
                                PerdasEfectivas := 0
                            else begin
                                ValorDesconto := 0;
                                ValorRemuneracao := 0;
    ...
    var
        ...
        recHistLinMovEmp: Record "Hist. Linhas Movs. Empregado";
        DescEmp: Decimal;
        DescEntPat: Decimal;
        FLAG: Boolean;
