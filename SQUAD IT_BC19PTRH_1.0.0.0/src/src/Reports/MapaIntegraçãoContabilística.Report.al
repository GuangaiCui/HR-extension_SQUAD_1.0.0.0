report 53070 "Mapa Integração Contabilística"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts\MapaIntegraçãoContabilística.rdl';
    ...
    dataset
    {
        dataitem("Periodos Processamento"; "Periodos Processamento")
        {
            ...
            dataitem("Movs. Empregado"; "Hist. Linhas Movs. Empregado")
            {
                ...
                begin
                    if "Movs. Empregado".Valor = 0.0 then
            ...
            dataitem(Dimensoes; "Integer")
            {
                ...
                column("Periodos_Processamento_Data__Processamento"; Format("Periodos Processamento"."Data Inicio Processamento") + ' a ' + Format("Periodos Processamento"."Data Fim Processamento"))
                {
                }
    ...
    var
        ...
        "INTEGRAÇÃO_CONTABILÍSTICACaptionLbl": Label 'INTEGRAÇÃO CONTABILÍSTICA';
