report 53044 "Mapa Seg. Social - Fechado"
{
    ...
    // 
    // 
    // //IT004 - CPA - 2016.10.21 - Alterações ao processamento por causa dos Acertos de Duodécimos
    // //IT005 - CPA - 2017.03.01 - Correcções por causa dos Acertos a negativo de Sub Natal e Férias (quando é retirado valor aos Empregados)
    // IT006 - JTP - 2020.06.08 - Contemplar férias não gozadas de anos diferentes
    // 
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts\MapaSegSocialFechado.rdl';
            ...
            dataitem("Regime Seg. Social"; "Regime Seg. Social")
            {
                ...
                dataitem(Empregado; Empregado)
                {
                    ...
                    begin
                        ...
                        //HG 04.05.2007 - o total das contribuições deve de ir buscar ao historico
    ...
    begin
        ...
        // IF (ROUND(Valorlancar,1) = 0) OR //HG 2007.03.20 coloquei em comentário pq se o valor é zero é porque houve falta o mês todo
        if (strNatrem = ' F') or   //p/ o Sub Férias, Natal, Comissões e Outros Subsidios o nº dias tem de ser zero
            ...
            DiasTrabalho := Format(Empregado."No. Dias Trabalho Mensal" * 10 - AuxDiasNTrabalhados);//trab temp parcial
                                                                                                    //DiasTrabalho := '300'; //HG 30.04.2007 - pus em comentário
            ...
            if TabHistAboDesExtra.Find('-') then begin
